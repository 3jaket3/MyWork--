%{
    4th - Order Runge-Kutta method for a system of 
    Odinary Differential Equations

    10/9/1017 Jake Tully

    This Script solves a system of ODE's with RK4 method
...
title('Solution of x');
legend('Approxcimate solution' , 'Exact solution', 'location','best');
